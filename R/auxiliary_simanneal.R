...
# optimized <- optimize_SeqCA(A, t=3, verbose=TRUE)
# cat("Optimized:", nrow(optimized), "rows\n")
#
# # Or just simulated annealing on a partial SeqCA
