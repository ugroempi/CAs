...
#' (SeqCAs) (Kuhn et al. 2012, Murray and Colbourn 2015 (not yet implemented), Torres-Jimenez et al. 2022):
#'
...
#' * \code{\link{reduce_rows_iterative_complete}} and \code{\link{optimize_SeqCA}} for reducing the run size of an SeqCA.
#'
