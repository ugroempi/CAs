...
#' (SCAs) (Kuhn et al. 2012, Murray and Colbourn 2015 (not yet implemented), Torres-Jimenez et al. 2022):
#'
#' * \code{\link{greedySCA_naive}}, \code{\link{greedySCA_Kuhn}}, \code{\link{greedySCA_TJ}}
#' and their iterative versions,
#' * \code{\link{coverageSCA}} and \code{\link{identify_needed}} for assessing coverage and usefulness / redundancy of SCA entries,
#' * \code{\link{reduce_rows_iterative_complete}} and \code{\link{optimize_SCA}} for reducing the run size of an SCA.
#'
#' These functions are limited to SCAs for relatively small numbers of columns and strengths.
#'
