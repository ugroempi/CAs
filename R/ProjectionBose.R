...
#'
#' @usage projectionBose(q, fixNA=TRUE, ...)
#' @usage N_projectionBose(k=NULL, v=NULL, ...)
#' @usage k_projectionBose(N, v=NULL, ...)
#'
...
#'
#' @returns \code{projectionBose} returns a (\code{q^2-3} x \code{q+1} matrix with columns in \code{q}-1 levels labeled from 0 to q-2 that is a covering array of strength 2.\cr
...
#' @export
projectionBose <- function(q, fixNA=TRUE, ...){
...
#' @export
N_projectionBose <- function(k=NULL, v=NULL, ...){
