...
#'
#' \code{NISTcat} and \code{TJcat} are matrices with columns
#' \code{t}, \code{k}, \code{v} and \code{N} (in different order, may change, always address via name!)
#' indicating the information on CAs that are available in the NIST (2008) library of CAs
